...
object RandomEffectCoordinate {
   ...
   * @param objectiveFunctionFactoryOpt The objective function factory option
  ...
  protected[ml] def apply[RandomEffectObjective <: SingleNodeObjectiveFunction](
      ...
      objectiveFunctionFactoryOpt: Option[GeneralizedLinearModel] => RandomEffectObjective,
