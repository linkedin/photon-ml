...
class LinearRegressionOptimizationProblemTest extends SparkTestUtils {
  import CommonTestUtils._
  import LinearRegressionOptimizationProblemTest._

  def generateUnweightedBenignLocalDataSet: List[LabeledPoint] = {
    drawSampleFromNumericallyBenignDenseFeaturesForLinearRegressionLocal(DATA_RANDOM_SEED, TRAINING_SAMPLES, DIMENSIONS)
...
object LinearRegressionOptimizationProblemTest {
  ...
  def createProblem(
    ...
    computeVariance: Boolean = false): LinearRegressionOptimizationProblem = {
