...
class LogisticRegressionOptimizationProblemTest extends SparkTestUtils {
  import CommonTestUtils._
  import LogisticRegressionOptimizationProblemTest._
...
object LogisticRegressionOptimizationProblemTest {
  ...
  def createProblem(
    ...
    computeVariance: Boolean = false): LogisticRegressionOptimizationProblem = {
