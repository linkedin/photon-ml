...
/**
 * Tests for CoordinateDescent.run without validation
 */
class CoordinateDescentTest {

  type CoordinateType = FixedEffectCoordinate[_ <: DistributedObjectiveFunction]
  ...
  /**
   * Test CoordinateDescent.run with validation
   */
  @Test
