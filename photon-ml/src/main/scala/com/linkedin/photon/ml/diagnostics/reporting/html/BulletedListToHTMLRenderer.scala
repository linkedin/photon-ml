...
class BulletedListToHTMLRenderer(renderStrategy: RenderStrategy[PhysicalReport, Node],
                                 ...
                                 htmlPrefix: String,
                                 svgPrefix: String) extends AbstractListToHTMLRenderer[BulletedListPhysicalReport]("ul", renderStrategy, numberingContext, namespaceBinding, htmlPrefix, svgPrefix)