...
/**
 * Similar to [[http://www.scalanlp.org/api/breeze/index.html#breeze.optimize.FirstOrderMinimizer\$State breeze.optimize.FirstOrderMinimizer.State]],
 ...
 * @author xazhang
 */
protected[optimization] case class OptimizerState(coefficients: Vector[Double],
                                                  value: Double,
