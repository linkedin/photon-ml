...
class SmoothedHingeLossLinearSVMAlgorithm
  ...
  override protected def createObjectiveFunction(
    ...
    // TODO: Ignore normalization for now - unclear what refactoring is necessary/appropriate to make this fit within
  ...
  override protected def createOptimizer(optimizerConfig: OptimizerConfig)
    : Optimizer[LabeledPoint, DiffFunction[LabeledPoint]] = OptimizerFactory.diffOptimizer(optimizerConfig)
