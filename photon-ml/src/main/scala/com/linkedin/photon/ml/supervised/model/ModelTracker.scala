...
// photon_trunk/mlease/src/main/scala/com/linkedin/mlease/spark/supervised/model/ModelTracker.scala:11: inferred existential type Option[(com.linkedin.photon.ml.optimization.OptimizationStatesTracker, Array[_$1])] forSome { type _$1 <: com.linkedin.photon.ml.supervised.model.GeneralizedLinearModel }, which cannot be expressed by wildcards,  should be enabled
