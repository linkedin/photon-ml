 ...
 */
class SectionToStringRenderer(renderStrategy: RenderStrategy[PhysicalReport, String], numberingContext: NumberingContext) extends SpecificRenderer[SectionPhysicalReport, String] {

  private val baseRenderer = new BaseSequencePhysicalReportRender[PhysicalReport, String](renderStrategy, numberingContext) {
