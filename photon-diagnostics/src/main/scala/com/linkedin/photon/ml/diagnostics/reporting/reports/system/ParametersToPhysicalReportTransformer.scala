...
//  private def getJobParameters(params: Params): BulletedListPhysicalReport = {
...
//  }
//
//  private def getIoParameters(params: Params): BulletedListPhysicalReport = {
//    new BulletedListPhysicalReport(
//      Seq(
...
//  }
//
//  private def getModelParameters(params: Params): BulletedListPhysicalReport = {
//    new BulletedListPhysicalReport(
//      Seq(
...
//    new BulletedListPhysicalReport(Seq(getJobParameters(params), getIoParameters(params), getModelParameters(params)))

  private def render(): BulletedListPhysicalReport =
    new BulletedListPhysicalReport(Seq())
}
