 ...
 *
 * @param nameToIndex Mapping of encoded (name, term) tuples &rarr; index
 * @param params Parameters used to launch the driver
 * @param summary Computed feature summary
 */
